...
const Horario = () => {
   return (
     <div>
      ...
      <div className="m-5">
        <h4 className="text-coral text-center">Mi horario</h4>
      </div>
      <div className="m-5">
        <img height="150px" src={Imagen} className="rounded mx-auto d-block" height="300px" alt="Horario"></img> 
      </div>
      <div className="m-5">
        <h4 className="text-coral text-center">Director de grupo:</h4>
        <h6 className="text-center text-danger">Diana Mosquera</h6>
      </div>
      <div className="m-5">
        <img height="150px" src={Imagen} className="rounded mx-auto d-block" height="300px" alt="Horario"></img>
      </div>
