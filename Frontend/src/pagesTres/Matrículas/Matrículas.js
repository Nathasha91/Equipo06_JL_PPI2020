  ...
  return (
    ...
    <div className="rootA">
      <div className="container-tituloA">
        <h2 className="text-warning"> I.E JAVIERA LONDOÑO SOLICITUD DE CUPOS PARA EL AÑO 2021</h2>
      ...
      <div className="container1">
        <div className="subcontainer col-6a col-6">
          ...
          <h4 className="text-warning">Apreciados padres de familia, estudiantes y docentes:</h4>
      ...
      <div className="container2 col-12 text-center">
        <a className="pdfdescarga col-12 text-warning" target="_blank"
      ...
      <div className="container3 col-12 container justify-content-center">
        <div className="Admi text-center col-4a col-4">
          ...
          <div className="donate-info">
            ...
            <div className="ah">
              <div class="amount"><a className="button buttonA text-warning" href="docs/ADMISIONES/ADMISIONES Y MATRÍCULAS.pdf">¡Descargar!</a></div>
            </div>
          </div>
        </div>
        ...
        <div className="Admi text-center col-4a col-4">
          ...
          <div className="donate-info">
            ...
            <div className="ah">
              <div class="amount"><a className="button buttonA text-warning" href="docs/ADMISIONES/PROCESOS_ADMISIONES_MATRICULAS.pdf">¡Descargar!</a></div>
            </div>
          </div>
        </div>
