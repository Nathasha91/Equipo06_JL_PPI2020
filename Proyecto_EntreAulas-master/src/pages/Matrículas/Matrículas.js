  ...
  return (
    ...
    <div className="root">
      <div className="container-titulo">
        <h2> I.E JAVIERA LONDOÑO SOLICITUD DE CUPOS PARA EL AÑO 2021</h2>
      ...
      <div className="container1">
        <div className="subcontainer col-6">
          <h2>SOLICITUD DE CUPOS 2021</h2>
          <h4>Apreciados padres de familia, estudiantes y docentes:</h4>
        ...
        <div className="subcontainer2 col-6">
      ...
      <div className="container2 col-12 text-center">
        ...
        >Descargar y leer instructivo de solicitud de cupos <img className="pdff" src={Pdf} /></a>

        <div className="row cupos text-center">
          <div className="col-4">
            <a className="btn btn-danger" target="_blank" alt="No hay cupos">No hay Cupos para Preescolar</a><br></br>
          ...
          <div className="col-4">
            ...
            <a className="btn btn-danger" target="_blank">No Hay Cupos para Grado 5</a><br></br>
      ...
      <div className="container3 col-12 ">
        <div className="Admi text-center col-4">
          ...
          <div className="donate-info">
            ...
            <div className="ah">
              <div class="amount"><a className="button" href="docs/ADMISIONES/ADMISIONES Y MATRÍCULAS.pdf">¡Descargar!</a></div>
            </div>
          </div>
        </div>
        ...
        <div className="Admi text-center col-4">
          ...
          <div className="donate-info">
            ...
            <div className="ah">
              <div class="amount"><a className="button" href="docs/ADMISIONES/PROCESOS_ADMISIONES_MATRICULAS.pdf">¡Descargar!</a></div>
            </div>
          </div>
        </div>
