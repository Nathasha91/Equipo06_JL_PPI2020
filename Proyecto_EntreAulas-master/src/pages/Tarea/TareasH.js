        ...
        <div>
          <div className="card text-center w=80% tareas">
            ...
            <div className="card-body">
              <h5 className="card-title text-warning">Hechas</h5>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title text-warning negrita" id="staticBackdropLabel">Taller N°1</h5>
                          ...
                          <div class="modal-body modal-margen">
                            ...
                            <h5 className="card-title text-warning">Nota: 4,5</h5>
                          ...
                          <div class="modal-footer">
                            <a href="#" class="btn btn-warning botones text-light">Reclamar</a>
                  ...
                  <div className="card-body">
                    ...
                    <div class="modal fade" id="staticBackdrop2" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title text-warning negrita" id="staticBackdropLabel">Taller N°2</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                  ...
                  <div className="card-body">
                    ...
                    <div class="modal fade" id="staticBackdrop3" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title text-warning negrita" id="staticBackdropLabel">Taller N°3</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
