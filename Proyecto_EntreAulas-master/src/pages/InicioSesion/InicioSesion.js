...
const InicioSesion = () => {
    return (
        <div className="m-5">
          <p class="text-center" >
            <a href="#" class="text-secondary">"Comprendiendo y viviendo la educación</a>
          </p>
          <p class="text-center">
            <a href="#" class="text-secondary">como derecho-deber".</a>
          </p>
          ...
          <div className="container">
            <form className=" form col-12 col-md-5">
                ...
                <div className="form-group col-md-6"></div>
                    <button type="submit" className=" btn btn-warning text-white col-12">Ingresar</button>
                </div>
                <div className="Boton2 btnform1">
                <div className="form-group col-md-6"></div>
                    <button type="submit" className=" btn btn-warning text-white col-12">Matriculas</button>
                </div>
              </form>
           </div>
        </div>
