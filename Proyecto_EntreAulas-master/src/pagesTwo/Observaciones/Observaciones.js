...
const Observaciones = () => {
    return (
        <div className="root rootO">
            ...
            <div className="text-violet tituloO"><h1>Observaciones</h1></div>
            ...
            <div className="card text-center">
                ...
                <div className="card-body">
                    <h4 className="card-title text-violet">Matemáticas</h4>
                        <div class="modal-body">
                            <textarea class="form-control" placeholder="Sin miedo que no mordemos..." id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                    <a href="/calificaciones2" className="btn text-light btn-violet">Volver a notas</a>
                </div>
